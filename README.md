...
See [CONTRIBUTING.md](CONTRIBUTING.md) for the release checklist. `dist/` is
generated by `pnpm build`, intentionally ignored by git, and included in npm
packages through the `files` allowlist.
